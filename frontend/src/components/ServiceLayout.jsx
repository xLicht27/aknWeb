...
const ServiceLayout = ({ highlights, benefits, image }) => {
  return (
        ...
        <section className="page-header">
          <div className="container">
            <div className="page-header-breadcrumb">
              <Link to="/">Inicio</Link> / <Link to="/servicios">Servicios</Link>
            </div>
            <h1>Nuestros Servicios Especializados</h1>
            <p>
              Ofrecemos soluciones integrales en ingeniería eléctrica, garantizando
              eficiencia y continuidad operativa para su empresa.
            </p>
          </div>
        </section>
      </div>
